...
def update_fft_and_inverse_plots(n_clicks, figure, start_time, end_time):
    ...
    if x0 is not None and x1 is not None:
        ...
        fft_fig.update_layout(
            title=dict(text='The frequency domain of the selected time domain after <span style="color:red"> DFT </span> transformation', font=dict(weight='bold')),
        ...
        inverse_amplitude_fig.update_layout(
            title=dict(text='After the <span style="color:red"> IDFT </span> transformation', font=dict(weight='bold')),
            xaxis_title='Time (s)',
            yaxis_title='Amplitude'
        )
